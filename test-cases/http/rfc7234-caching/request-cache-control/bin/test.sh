...
sleep 2 && $app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Cache-Control: max-age=1"

tty_printf "Include 'max-age=0' Cache-Control directive in the request
and test: receives a fresh 200 response (miss).\n"
$app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Cache-Control: max-age=0"
...
$app_vendor_zerustech_cli_bin/http/http.ban -l ^/ && $app_vendor_zerustech_cli_bin/http/http.get -l /index.php

tty_printf "Include 'no-cache' Cache-Control directive in the request and test:
receives a fresh 200 response (miss).\n"
$app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Cache-Control: no-cache"
...
and test: receives a fresh 200 response (miss).\n"
$app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Cache-Control: no-store"
...
$app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Cache-Control: only-if-cached"

tty_printf "Ban and test again: fails with a 503 response.\n"
$app_vendor_zerustech_cli_bin/http/http.ban -l ^/ && $app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Cache-Control: only-if-cached"
...
test: receives a cached 200 response (hit).\n"
$app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Cache-Control: min-fresh=1"
...
sleep 3 && $app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Cache-Control: min-fresh=3"
...
(hit).\n"
sleep 8 && $app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Cache-Control: max-stale=5"

tty_printf -f green "Include 'max-stale=1' Cache-Control directive in the
request and test: receives a fresh 200 response (miss).\n"
$app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Cache-Control: max-stale=1"
...
$app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Accept-Encoding: gzip" "Cache-Control: max-age=0"
...
response.\n"
$app_vendor_zerustech_cli_bin/http/http.get -l /index.php "Accept-Encoding: gzip" "Cache-Control: max-age=0,no-transform"
