...
# stale contents.
$service/php.start -o 8000 && $service/php.start -o 8001 && $service/varnish.start "-p default_grace=0"
...
$service/php.stop -o 8000 && $service/php.stop -o 8001 && $service/varnish.stop
